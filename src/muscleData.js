...
export const EXERCISE_MUSCLES = Object.freeze({
  ...
  'backpack-row': muscles(['lats', 'upperBack'], ['biceps', 'rearDelts', 'lowerBack']),
  'single-arm-backpack-row': muscles(['lats', 'upperBack'], ['biceps', 'rearDelts', 'obliques']),
  'bottle-bent-over-row': muscles(['lats', 'upperBack'], ['biceps', 'rearDelts', 'lowerBack']),
  'bottle-biceps-curl': muscles(['biceps'], ['forearms']),
  'bottle-hammer-curl': muscles(['biceps', 'forearms']),
  'bottle-shoulder-press': muscles(['frontDelts', 'sideDelts'], ['triceps']),
  'bottle-lateral-raise': muscles(['sideDelts'], ['upperBack']),
  'bottle-rear-delt-fly': muscles(['rearDelts'], ['upperBack', 'lowerBack']),
  'bottle-overhead-triceps-extension': muscles(['triceps']),
  'backpack-romanian-deadlift': muscles(['hamstrings', 'glutes'], ['lowerBack', 'abs', 'forearms']),
  'bodyweight-good-morning': muscles(['hamstrings', 'glutes'], ['lowerBack', 'abs']),
  'indoor-walk': muscles(['glutes', 'calves'], ['quads', 'hamstrings', 'hipFlexors']),
